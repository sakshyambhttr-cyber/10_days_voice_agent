...
## Overview
Day 5 empowers **BolBuddy** with real structured tools. Instead of relying solely on hardcoded prompts or static dialogue generation, BolBuddy can now execute functions dynamically to fetch domain-specific speaking exercises and evaluate completed spoken answers with structured numerical and qualitative feedback.
...
- Standalone tool reference: [day-05/tools/exercise_tool.py](file:///c:/Users/livel/Downloads/murffff/murf-livekit-starter/day-05/tools/exercise_tool.py).
...
- Standalone tool reference: [day-05/tools/answer_scoring.py](file:///c:/Users/livel/Downloads/murffff/murf-livekit-starter/day-05/tools/answer_scoring.py).

---

## Data Source
- **Dataset Type**: Curated local dataset ([day-05/tools/exercise_data.json](file:///c:/Users/livel/Downloads/murffff/murf-livekit-starter/day-05/tools/exercise_data.json)).
...
## Demo Scenario
See [day-05/examples/demo.md](file:///c:/Users/livel/Downloads/murffff/murf-livekit-starter/day-05/examples/demo.md) for the complete video script and demonstration dialogue.
