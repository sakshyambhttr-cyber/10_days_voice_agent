          ...
          >
            <div className="relative flex size-72 items-center justify-center sm:size-80">
              ...
              <motion.div
                ...
                className="group relative flex size-52 cursor-pointer items-center justify-center rounded-full bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-500 p-1 shadow-2xl shadow-indigo-500/35 sm:size-60"
                onClick={onStartCall}
              >
