...
async def run_manual_verification():
    ...
    async with AgentSession(llm=llm_obj) as session1:
        ...
        print("User: 'I want to practice English.'")
    ...
    async with AgentSession(llm=llm_obj) as session2:
        ...
        res2 = await session2.run(
            user_input="I want to talk to a real English teacher."
        )
        msg2 = ""
        tools2 = []
        ...
        print("User: 'I want to talk to a real English teacher.'")
    ...
    async with AgentSession(llm=llm_obj) as session5:
        ...
        res5 = await session5.run(
            user_input="I'm getting really overwhelmed and anxious whenever I try to speak English. I think I need someone to help me."
        )
        msg5 = ""
        tools5 = []
        ...
        print(
            "User: 'I'm getting really overwhelmed and anxious whenever I try to speak English. I think I need someone to help me.'"
        )
    ...
    async with AgentSession(llm=llm_obj) as session6:
        ...
        res6 = await session6.run(
            user_input="I don't understand this grammar question."
        )
        msg6 = ""
        tools6 = []
        ...
        print("User: 'I don't understand this grammar question.'")
